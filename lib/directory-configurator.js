...
class DirectoryConfigurator extends Configurator {
	/**
	 * @constructor
	 * @param {String|RegExp} [basename='/\.dir-locals\.[json|ya?ml]/'] - Basename of the config files.
	 * @param [opts]
	 ...
	 */
	constructor(
		basename = /\.dir-locals\.[json|ya?ml]/,
		{
		...
		super(this.getFullConfig(), { extraTags, env, defaults, overrides });
	}
